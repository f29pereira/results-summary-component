import type { BannerColorType, BannerType } from "@/app/type";
import styles from "./Skill.module.css";

/**
 * Returns the css module classes for a given banner type
 * @param type type of banner
 */
export const getSkillStyles = (type: BannerColorType) => {
  switch (type) {
    case "danger":
      return { bannerBg: styles.dangerBg, bannerText: styles.dangerText };
    case "warning":
      return { bannerBg: styles.warningBg, bannerText: styles.warningText };
    case "success":
      return { bannerBg: styles.successBg, bannerText: styles.successText };
    case "info":
      return { bannerBg: styles.infoBg, bannerText: styles.infoText };
    default:
      return { bannerBg: "", bannerText: "" };
  }
};

/**
 * Returns the svg icon for a given banner type
 * @param type type type of banner
 */
export const getSkillIcon = (type: BannerType) => {
  switch (type) {
    case "Reaction":
      return (
        <svg
